...
async function loadDoc(){
    const xml = await get("http://api.openweathermap.org/data/2.5/forecast?q=Paris,fr&units=metric&lang=fr&mode=xml&APPID=9cd4ed2efdb62088151c9aed6e319657", mode='xml')
